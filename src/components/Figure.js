...
//This component returns the hangman figure
//The rod is always displayed and when the user enters a wrong letter
//then the head figure is displayed and if they enter more wrong letters then more parts
//of the figure are displayed
